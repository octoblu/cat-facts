module.exports =  [  "Every year, nearly four million cats are eaten in Asia.",
  ...
  # "    <table width="172" border="0" cellspacing="0" cellpadding="0" align="right">    <tbody><tr>    <td align="center" style="font-size: 10px; color: #333; padding: 0px 0px 7px 12px; line-height: normal;">    <img src="http:#www.randomhistory.com/photos/2010/cat-rub.jpg" alt="cat rub" width="158" height="107" border="0" style="border: solid 1px #333; margin-bottom: 4px;"><br>A cat rubs against people to mark them as their territory     </td>    </tr>    </tbody></table>  A cat rubs against people not only to be affectionate but also to mark out    its territory with scent glands around its face. The tail area and paws also    carry the cat’s scent.",
  ...
  # "    <table width="172" border="0" cellspacing="0" cellpadding="0" align="right">    <tbody><tr>    <td align="center" style="font-size: 10px; color: #333; padding: 0px 0px 7px 12px; line-height: normal;">    <img src="http:#www.randomhistory.com/photos/2010/siamese-cross-eyed.jpg" alt="Siamese  cross eyed " width="158" height="102" border="0" style="border: solid 1px #333; margin-bottom: 4px;"><br>    Some Siamese cats are cross-eyed to compensate for abnormal optic wiring    </td>    </tr>    </tbody></table>  Some Siamese cats appear cross-eyed because the nerves from the left side    of the brain go to mostly the right eye and the nerves from the right side    of the brain go mostly to the left eye. This causes some double vision, which    the cat tries to correct by “crossing” its eyes.",
  ...
  # "Spanish-Jewish folklore recounts that Adam’s first wife, Lilith, became    a black <a href="http:#facts.randomhistory.com/2009/05/02_vampires.html">vampire</a> cat, sucking the blood from sleeping babies. This may be    the root of the superstition that a cat will smother a sleeping baby or suck    out the child’s breath.",
  ...
  # "    <table width="172" border="0" cellspacing="0" cellpadding="0" align="right">    <tbody><tr>    <td align="center" style="font-size: 10px; color: #333; padding: 0px 0px 7px 12px; line-height: normal;">    <img src="http:#www.randomhistory.com/photos/2010/cat-detective.gif" alt="Cat Detective" width="158" height="107" border="0" style="border: solid 1px #333; margin-bottom: 4px;"><br>    Two Siamese cats discovered microphones hidden by Russian spies in Holland’s embassy in Moscow    </td>    </tr>    </tbody></table>  In Holland’s embassy in Moscow, Russia, the staff noticed that the    two Siamese cats kept meowing and clawing at the walls of the building. Their    owners finally investigated, thinking they would find mice. Instead, they    discovered microphones hidden by Russian spies. The cats heard the microphones    when they turned on.",
  ...
  # "    <table width="172" border="0" cellspacing="0" cellpadding="0" align="right">    <tbody><tr>    <td align="center" style="font-size: 10px; color: #333; padding: 0px 0px 7px 12px; line-height: normal;">    <img src="http:#www.randomhistory.com/photos/2010/cat-face-to-face.jpg" alt="cat face to face" width="158" height="119" border="0" style="border: solid 1px #333; margin-bottom: 4px;"><br>    Many cat owners think their cats can read their minds    </td>    </tr>    </tbody></table>  Approximately 1/3 of cat owners think their pets are able to read their    minds.",
  ...
  # "    <table width="172" border="0" cellspacing="0" cellpadding="0" align="right">    <tbody><tr>    <td align="center" style="font-size: 10px; color: #333; padding: 0px 0px 7px 12px; line-height: normal;">    <img src="http:#www.randomhistory.com/photos/2010/cat-sleeping.jpg" alt="cat sleeping" width="158" height="105" border="0" style="border: solid 1px #333; margin-bottom: 4px;"><br>    During the nearly 18 hours a day that kittens sleep, an important growth hormone is released    </td>    </tr>    </tbody></table>  One reason that kittens sleep so much is because a growth hormone is released    only during sleep.",
  ...
  # "    <table width="172" border="0" cellspacing="0" cellpadding="0" align="right">    <tbody><tr>    <td align="center" style="font-size: 10px; color: #333; padding: 0px 0px 7px 12px; line-height: normal;">    <img src="http:#www.randomhistory.com/photos/2010/cat-paws.jpg" alt="cat paws" width="158" height="105" border="0" style="border: solid 1px #333; margin-bottom: 4px;"><br>    Cat’s sweat only through their paws    </td>    </tr>    </tbody></table>  Cats don’t have sweat glands over their bodies like humans do. Instead,    they sweat only through their paws.",
  ...
  # "The cat who holds the record for the longest non-fatal fall is Andy. He    fell from the 16<sup>th</sup> floor of an apartment building (about 200 ft/.06 km) and    survived.",
